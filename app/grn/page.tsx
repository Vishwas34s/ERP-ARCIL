...
export default function GrnPage() {
  ...
  function validateDraft() {
    ...
    const acceptedQuantity = draft.acceptedQuantity ?? 0;
    const rejectedQuantity = draft.rejectedQuantity ?? 0;
    if (acceptedQuantity + rejectedQuantity !== draft.quantityReceived) {
